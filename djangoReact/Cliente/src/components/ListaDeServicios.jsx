...
export function VerServicios(){
    ...
    return (
        <div>
            ...
            <ul>            
                <li><Link to='/AgregarServicio' className="a">Volver</Link></li>
            </ul>
                                        ...
                                        const aceptarActualizar = Swal.mixin({
                                          ...
                                          aceptarActualizar.fire({
                                            ...
                                            if (result.isConfirmed) {                                                                                    
                                                navigate(`/ActualizarServicio/${ser.codigo_ser}`)                                           
                                            } else if (
                                    ...
                                    <a onClick={() =>{                    
                                        const aceptarElimnar = Swal.mixin({
                                          ...
                                          aceptarElimnar.fire({
                                            ...
                                            if (result.isConfirmed) {                                                                                    
                                                navigate(`/EliminarServicio/${ser.codigo_ser}`)                                           
                                            } else if (
                                              /* Read more about handling dismissals below */
                                              result.dismiss === Swal.DismissReason.cancel
                                            ) {
                                              aceptarElimnar.fire({
                                                title: "Operacion Cancelada",
                                                text: "No se eliminara el servicio seleccionado",
                                                icon: "error",
                                                confirmButtonColor:'#ff2d2d',   
                                                confirmButtonText: "Volver atras"                                                         
                                            });
