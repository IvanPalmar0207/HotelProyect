...
export function InicioMeseroRoom(){
    ...
    return (    
        ...
        <header>
            ...
            <h1 class="tituloEncabezado">BIENVENIDO MESERO O ROOM SERVICE</h1>
            <div class="logoIzquierdo">
                <img src={imagePlaya} alt="logoIzquierda" />
            </div>
        </header>
        ...
        <div class="contenedorEnlaces">
            <ul>                
                <li><Link to='/ListaServiciosMERS' className="a">Consultar Servicios</Link></li>            
                <li><Link to='/AgregarConsumoMR' className="a">Cargar Consumos</Link></li>                            
