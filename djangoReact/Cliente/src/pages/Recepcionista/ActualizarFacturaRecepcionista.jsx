...
export function AgregarConsumoRecepcionista(){
           ...
           return false   
            ...
            try{            
                ...
                Swal.fire({
                    ...
                    text: "El consumo ha sido aactualizado correctamente",            
                });             
    ...
    return (
            ...
            <div>                        
                ...
                <div className="contenedorEnlaces">
                    <ul>
                        <li><Link to='/AgregarFacturaRecepcionista' className="a">Volver</Link></li>                        
                    </ul>   
                </div>
