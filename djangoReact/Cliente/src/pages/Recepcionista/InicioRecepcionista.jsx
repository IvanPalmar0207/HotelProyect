...
export function InicioRecepcionista(){
    ...
    return (    
        ...
        <header>
            ...
            <h1 class="tituloEncabezado">BIENVENIDO RECEPCIONISTA</h1>
            <div class="logoIzquierdo">
                <img src={imagePlaya} alt="logoIzquierda" />
            </div>
        </header>
        ...
        <div class="contenedorEnlacesNavigation">
            <ul>                
                <li><Link to='/ListaHabitacionesRecepcionista' className="a">Consultar Habitaciones</Link></li>
                <li><Link to='/AgregarReservaRecepcionista' className="a">Modulo de Reservas</Link></li>  
                <li><Link to='/ListaServiciosRecepcionista' className="a">Consultar Servicios</Link></li>  
                <li><Link to='/ListaCategoriasRecepcionista' className="a">Consultar Categorias</Link></li>
                <li><Link to='/AgregarFacturaRecepcionista' className="a">Modulo de Facturas</Link></li>  
