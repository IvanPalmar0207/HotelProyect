...
export function ListaReservasRecepcionista(){
    ...
    return (
        <div>
            ...
            <ul>            
                <li><Link to='/AgregarReservaRecepcionista' className="a">Volver</Link></li>
            </ul>
                                        ...
                                        const aceptarActualizar = Swal.mixin({
                                          ...
                                          aceptarActualizar.fire({
                                            ...
                                            if (result.isConfirmed) {                                                                                    
                                                navigate(`/ActualizarReservaRecepcionista/${reserva.codigo_res}`)                                           
                                            } else if (
                                    ...
                                    <a onClick={() =>{                    
                                        const aceptarElimnar = Swal.mixin({
                                          ...
                                          aceptarElimnar.fire({
                                            ...
                                            if (result.isConfirmed) {                                                                                    
                                                navigate(`/EliminarReservaRecepcionista/${reserva.codigo_res}`)                                           
                                            } else if (
                                              result.dismiss === Swal.DismissReason.cancel
                                            ) {
                                              aceptarElimnar.fire({
