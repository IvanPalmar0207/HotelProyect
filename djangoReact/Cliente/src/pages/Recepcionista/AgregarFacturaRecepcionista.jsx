...
export function AgregarFacturaRecepcionista(){
            ...
            <div>                        
                ...
                <div className="contenedorEnlaces">
                    <ul>
                        ...
                        <li><Link to='/ListaFacturasRecepcionista' className="a">Ver Facturas</Link></li>        
                        <li><Link to='/AgregarConsumoRecepcionista' className="a">Actualizar Factura</Link></li>                       
                    </ul>   
                </div>
