...
export function ListaReservasCliente(){
        ...
        <div>
            ...
            <table className="table">
                <thead className="table-info">
                    ...
                    <tbody>              
                        {reservas.filter(reserva => reserva.numeroDocumento_cli === params.numeroDocumento).map( reserva => {                                                
                            let fechaInicio = new Date(reserva.fechaInicio_res)
                            let fechaSalida = new Date(reserva.fechaSalida_res)
                            return(
                            <tr key={reserva.codigo_res} style={{textAlign:'center'}}>
                                        ...
                                        const aceptarActualizar = Swal.mixin({
                                          ...
                                          aceptarActualizar.fire({
                                            ...
                                            if (result.isConfirmed) {                                                                                    
                                                navigate(`/ActualizarReservaCliente/${reserva.codigo_res}`)                                           
                                            } else if (
                                    ...
                                    <a onClick={() =>{                    
                                        const aceptarElimnar = Swal.mixin({
                                          ...
                                          aceptarElimnar.fire({
                                            ...
                                            if (result.isConfirmed) {                                                                                    
                                                navigate(`/EliminarReservaCliente/${reserva.codigo_res}`)                                           
                                            } else if (
                                              result.dismiss === Swal.DismissReason.cancel
                                            ) {
                                              aceptarElimnar.fire({
