...
export function InicioCliente(){
    ...
    return (    
        ...
        <div class="contenedorEnlacesNavigation">
            <ul>                
                <li><Link to='/ListaHabitacionesCliente' className="a">Consultar Habitaciones</Link></li>                 
                <li><Link to='/ListaServiciosCliente' className="a">Consultar Servicios</Link></li>  
                <li><Link to='/ListaCategoriasCliente' className="a">Consultar Categorias</Link></li>
                <li><Link to='/ValidarFacturas' className="a">Consultar Facturas</Link></li>  
                <li><Link to='/AgregarReservaCliente' className="a">Comienza a Reservar</Link></li>  
