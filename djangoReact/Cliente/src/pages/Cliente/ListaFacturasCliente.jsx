...
export function ListaFacturasCliente(){
    ...
    return (
        <div>
            ...
            <ul>            
                <li><Link to='/ValidarFacturas' className="a">Volver</Link></li>
            </ul>
            ...
            <table className="table">
                <thead className="table-info">
                    ...
                    <tbody>              
                    {factura.map(fac => {
                        const reserva1 = reserva.find(res => res.numeroDocumento_cli === params.numeroDocumento && res.codigo_res === fac.codigo_res);
                        let fechaEmision1 = new Date(fac.fechaEmision_fac)
                        if (reserva1) {
                        return (
                        <tr key={fac.codigo_fac} style={{textAlign: 'center'}}>
