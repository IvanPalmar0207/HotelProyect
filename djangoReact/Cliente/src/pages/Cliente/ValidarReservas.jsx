...
export function ValidarReservas(){
    ...
    const envioForm = handleSubmit(async (data) => {        
            ...
            if(data.numeroDocumento_usu.length < 5){
                Swal.fire({
                    icon: 'error',
                    title: 'Oops...',
                ...
                console.log(data.numeroDocumento_usu.length)
                return false
            }else if(data.numeroDocumento_usu.match(minusculas) || data.numeroDocumento_usu.match(mayusculas)){
                Swal.fire({
                    icon: 'error',
                    title: 'Oops...',
                ...
                if(codigo_rl == 2){
                    Swal.fire({
                        ...
                        text: "Ahora podras visualizar todas tus reservas",            
                    })
                    navigate(`/ListaReservasCliente/${data.numeroDocumento_usu}`) 
                    return true
                }
                else if(codigo_rl != 2){
                    Swal.fire({
    ...
    return (
            ...
            <div>                        
                <header>
                    ...
                    <h1 className="tituloEncabezado">Validar las Reservas</h1>
                    <div className="logoIzquierdo">
                        <img src={imagePlaya} alt="logoIzquierda" />
                    </div>
                </header>
                ...
                <div className="contenedorEnlaces">
                    <ul>
                        <li><Link to='/AgregarReservaCliente' className="a">Volver</Link></li>
                    </ul>   
                </div>
